...
<div class="container">
	<div align='center'>
		...
		<form action="${pageContext.request.contextPath}/message/false?id=${Message.mid}" method="post" enctype="multipart/form-data">

		<table class="table">
			<thead class="thead-dark">
				<tr>
<%-- <c:forEach items="${AllItem}" var="m">  --%>
					<th scope="col"><input id="newmcontext" name="newmcontext" value="${Message.mcontext}" type="hidden" ></textarea></th>
					...
					<th scope="col"><input type="submit" value="刪除"></th>
<%-- 				</c:forEach> --%>
				</tr>
			</thead>
			<tbody>
