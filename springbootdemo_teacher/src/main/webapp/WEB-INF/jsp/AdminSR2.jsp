				...
				<div class="table-responsive">
					<table class="table table-striped table-sm" id="list_data_json">
						<thead>
							<tr>
								<th scope="col"
									style="vertical-align: middle; vertical-align: top ;text-align: center">消費者ID</th>
								<th scope="col"
								...
								<th scope="col"
									style="vertical-align: middle; vertical-align: top;text-align: center">商品名稱</th>
								<th scope="col"
									style="vertical-align: middle; vertical-align: top;text-align: center">商品圖片</th>
								<th scope="col"
									style="vertical-align: middle; vertical-align: top;text-align: center">價格</th>
								<th scope="col"
									style="vertical-align: middle; vertical-align: top;text-align: center">商品分類</th>
								<th scope="col"
									style="vertical-align: middle; vertical-align: top;text-align: center">廠商ID</th>
								<th scope="col"
									style="vertical-align: middle; vertical-align: top;text-align: center">商品狀況</th>
								<th scope="col"
									style="vertical-align: middle; vertical-align: top;text-align: center">廠商名稱</th>
								<th scope="col"
									style="vertical-align: middle; vertical-align: top;text-align: center">成交狀況</th>
							</tr>
						</thead>
						<tbody>
							...
							<c:forEach items="${data}" var="findall">
									...
									<td style="vertical-align: middle; text-align: center;">${findall.shophousebean.retailerBean.rid}</td>
